...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "hero.stats.clinics.num": "70%",
    "hero.stats.clinics.lbl": "Ahorro promedio vs precios en EE.UU.",
    "hero.stats.patients.num": "100%",
    "hero.stats.patients.lbl": "Procedimientos gestionados de principio a fin",
    "hero.stats.satisfaction.num": "24/7",
    "hero.stats.satisfaction.lbl": "Acompañamiento durante todo tu proceso",
    "hero.feature1.title": "70% Ahorro Promedio",
    "hero.feature1.desc": "vs precios en EE.UU.",
    "hero.feature2.title": "100% Gestionado",
    "hero.feature2.desc": "Procedimientos coordinados de principio a fin",
    "hero.feature3.title": "24/7 Acompañamiento",
    "hero.feature3.desc": "Durante todo tu proceso de salud",
    "hero.right.tagline": "Conectamos pacientes con\n— las mejores clínicas y especialistas de Colombia.",
  ...
  en: {
    ...
    "hero.stats.clinics.num": "70%",
    "hero.stats.clinics.lbl": "Average savings vs. US prices",
    "hero.stats.patients.num": "100%",
    "hero.stats.patients.lbl": "Procedures managed from start to finish",
    "hero.stats.satisfaction.num": "24/7",
    "hero.stats.satisfaction.lbl": "Support throughout your entire journey",
    "hero.feature1.title": "70% Average Savings",
    "hero.feature1.desc": "vs. US prices",
    "hero.feature2.title": "100% Managed",
    ...
    "hero.right.tagline": "We connect patients with\n— the best clinics and medical specialists in Colombia.",
